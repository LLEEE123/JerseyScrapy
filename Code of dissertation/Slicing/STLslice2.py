...
def intersect(facet, z_ind, params, auxdata, verbose):
    ...
    # Any other case, where facet is not oriented close to surface.
        ...
        # Case 1. Two points in layer. Triangle inequality guarantees third point also in segment.
        ...
        # Case 2. One point amid layer.
        elif len(points_mid_layer) == 1:
            if len(points_abv_layer) == 1:            
                x1, y1, z1 = points_mid_layer[0][0], points_mid_layer[0][1], z_ind
                x2, y2, z2  = (points_abv_layer[0][0]+points_blw_layer[0][0])/2,(points_abv_layer[0][1]+points_blw_layer[0][1])/2, z_ind
                segments.append(((x1, y1, z1), (x2, y2, z2)))
            else :
                continue
