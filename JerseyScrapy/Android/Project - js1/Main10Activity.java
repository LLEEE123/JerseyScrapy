...
public class Main10Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] resultlist = b.getStringArray("ScrapeResult8");
        ...
        ArrayAdapter<String> list = new ArrayAdapter<String>(Main10Activity.this,android.R.layout.simple_list_item_1,finallist);
