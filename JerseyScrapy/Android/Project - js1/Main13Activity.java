...
public class Main13Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] resultlist = b.getStringArray("ScrapeResult11");
        ...
        ArrayAdapter<String> list = new ArrayAdapter<String>(Main13Activity.this,android.R.layout.simple_list_item_1,finallist);
