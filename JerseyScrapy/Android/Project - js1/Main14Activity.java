...
public class Main14Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] resultlist = b.getStringArray("ScrapeResult12");
        ...
        ArrayAdapter<String> list = new ArrayAdapter<String>(Main14Activity.this,android.R.layout.simple_list_item_1,finallist);
