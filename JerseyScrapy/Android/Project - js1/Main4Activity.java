...
public class Main4Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] resultlist = b.getStringArray("ScrapeResult2");
        ...
        ArrayAdapter<String> list = new ArrayAdapter<String>(Main4Activity.this,android.R.layout.simple_list_item_1,finallist);
