...
public class Main5Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] resultlist = b.getStringArray("ScrapeResult3");
        ...
        ArrayAdapter<String> list = new ArrayAdapter<String>(Main5Activity.this,android.R.layout.simple_list_item_1,finallist);
