...
public class Main6Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] resultlist = b.getStringArray("ScrapeResult4");
        ...
        ArrayAdapter<String> list = new ArrayAdapter<String>(Main6Activity.this,android.R.layout.simple_list_item_1,finallist);
