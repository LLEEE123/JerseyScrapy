...
public class Main7Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] resultlist = b.getStringArray("ScrapeResult5");
        ...
        ArrayAdapter<String> list = new ArrayAdapter<String>(Main7Activity.this,android.R.layout.simple_list_item_1,finallist);
