...
public class Main8Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] resultlist = b.getStringArray("ScrapeResult6");
        ...
        ArrayAdapter<String> list = new ArrayAdapter<String>(Main8Activity.this,android.R.layout.simple_list_item_1,finallist);
