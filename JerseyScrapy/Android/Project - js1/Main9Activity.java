...
public class Main9Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] resultlist = b.getStringArray("ScrapeResult7");
        ...
        ArrayAdapter<String> list = new ArrayAdapter<String>(Main9Activity.this,android.R.layout.simple_list_item_1,finallist);
